...
createChannel(){
    ...
    # This is BigBang => Suddenly, an org appears.
    setGlobalUserForPeer0Org1
    
    peer channel create -o localhost:7050 -c $CHANNEL_NAME \
    --ordererTLSHostnameOverride orderer.example.com \
    -f ./artifacts/channel/${CHANNEL_NAME}.tx --outputBlock ./channel-creation/${CHANNEL_NAME}.block \
...
joinChannel(){
    setGlobalUserForPeer0Org1
    peer channel join -b ./channel-creation/$CHANNEL_NAME.block
